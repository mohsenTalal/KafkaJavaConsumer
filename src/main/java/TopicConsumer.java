...
public class TopicConsumer {
    public static void main(String[] args) {
        ...
        if (type.equals("consumer")) {
            ...
            consumer.subscribe(Collections.singletonList(topic), (org.apache.kafka.clients.consumer.ConsumerRebalanceListener) rebalanceListener);
            ...
            for (int i = 0; i < 1000; i++) {
                ...
                producer.send(data, (org.apache.kafka.clients.producer.Callback) callback);
